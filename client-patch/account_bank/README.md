...
Panel **v2.1** shows a reason directly beneath each disabled item action: the exact bank-Zeny shortfall, missing eligible items, inventory capacity, invalid quantity, bank limits or connection/save status. For example, a bank balance of 1,000,000 needs another **2,000 Zeny deposited** before buying one 1M Zeny Ticket. The character's on-hand balance does not fund the purchase until deposited. See the [bank feedback guide](../../doc/bank_feedback_20260913.md).
